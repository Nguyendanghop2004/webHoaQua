<script src="{{ asset('https://cdn.jsdelivr.net/npm/jquery@2.2.4/dist/jquery.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/admins/assets/js/main.js') }}"></script>
    ...
    <script src="{{ asset('assets/admins/assets/js/init/weather-init.js') }}"></script>
    ...
    <script src="{{ asset('assets/admins/assets/js/init/fullcalendar-init.js') }}"></script>